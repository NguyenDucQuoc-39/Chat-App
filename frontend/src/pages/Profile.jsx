...
function Profile() {
    ...
    let [frontendImage, setFrontendImage] = useState(userData.image || gojo);
        ...
        <div className="w-full h-[100vh] bg-slate-200 flex flex-col
         justify-center items-center gap-[20px] " >
            ...
            <div className=" bg-white rounded-full border-4 border-black
                ...
                <div className='absolute bottom-4  text-gray-700 right-4 w-[30px] h-[30px] 
                rounded-full bg-black flex justify-center items-center shadow-gray-300 shadow-lg'>
                    <IoCameraOutline className=' text-white w-[25px] h-[25px] ' />
                </div>
            </div>
            <form className='w-[95%]  max-w-[500px] flex flex-col gap-[20px] justify-center
                items-center' onSubmit={handleProfile}>
                <input type="file" accept='image/*' ref={image} hidden onChange={handleImage} />
                <input type="text" placeholder="Enter your name" className="w-[90%] h-[50px] 
                outline-none border-2 border-[#000000] px-[20px] py-[10px] bg-white 
                rounded-lg shadow-gray-400 shadow-lg text-gray-700 text-[19px]" onChange={(e) => setName(e.target.value)} value={name} />
                <input type="text" readOnly className="w-[90%] h-[50px] outline-none 
                border-2 border-[#000000] px-[20px] py-[10px] bg-white rounded-lg
                ...
                <button className="px-[20px] py-[10px] bg-black text-white rounded-2xl
