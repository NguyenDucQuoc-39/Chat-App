        ...
        <div className="lg:w-[30%] w-full h-full bg-slate-200 ">
            ...
            <div className='w-full h-[300px] bg-black rounded-b-[30%] shadow-gray-400 shadow-lg flex flex-col justify-center px-[20px]'>
                ...
                <div className="w-full flex justify-between items-center text-white">
                    ...
                    <div className='w-[60px] h-[60px] rounded-full overflow-hidden flex justify-center items-center shadow-white shadow-lg cursor-pointer' onClick={() => navigate("/profile")}>
                ...
                <div className="w-full flex items-center gap-[20px] ">
                    ...
                    {search &&
                        <form className='w-full h-[60px] bg-white shadow-gray-500 shadow-lg flex justify-center gap-[20px] mt-[10px] rounded-full overflow-hidden px-[20px]'>
                            <IoIosSearch className='w-[25px] h-[25px]'/>
...
{otherUsers?.map((user) => (
                    <div className='w-[60px] h-[60px]  rounded-full overflow-hidden flex justify-center items-center shadow-white shadow-lg'>
